...
class User extends AppModel {
	...
	//comparar password introducido con el verdadero
	...
	function hashPasswords($data, $enforce=false) {
        ...
        //se activa cuando la función Dar su información
    ...
    //Graba la ultima session de un usuario
    ...
    //retorna nuevos usuarios registrados en un dia
